...
namespace RAT {
  ...
  public:
    ...
    void GenerateEvent(const G4ThreeVector& nu_dir,
		...
		inline const G4String & GetNuType() const { return fNuType;};
...
//		void LoadGenerator();
	...
	protected:
        ...
        /** defines whether flux or interaction spectrum */ 
        bool ApplyCrossSection;

        /** name of the spectrum if database is ES.
         * Defaults to closest_boulby.
         */
        G4String Spectrum;
