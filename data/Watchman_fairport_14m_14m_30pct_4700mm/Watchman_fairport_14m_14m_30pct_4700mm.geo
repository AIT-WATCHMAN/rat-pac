...
type: "box",
size: [30050.0, 27300.0, 30700.0], // mm, half-length
...
position: [0.0, 0.0, 4823.0], //this will allow for the concrete layer on the floor and not on the ceiling
material: "rock",
...
mother: "cavern_2",
type: "tube",
r_max: 7050.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 7050.0,
position: [0.0, 0.0, -4150.0],
material: "stainless_steel",
...
type: "tube",
r_max: 5091.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 5091.0,
...
mother: "psup",
type: "tube",
r_max: 5085.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 5085.0,
position: [0.0, 0.0, 0.0],
material: "doped_water",
color: [0.2,0.2,0.9,0.2],
...
type: "tube",
r_max: 4705.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 4705.0,
position: [0.0, 0.0, 0.0],
...
type: "tube",
r_max: 4550.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 4550.0,
position: [0.0, 0.0, 0.0],
material: "doped_water",
color: [0.2,0.2,0.9,0.2],
...
type: "pmtarray",
end_idx: 2335, //idx of the last pmt
