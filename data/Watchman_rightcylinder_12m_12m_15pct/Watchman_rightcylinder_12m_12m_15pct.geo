...
//type: "box",
//size: [4498.125, 24498.125, 4498.125], // mm, half-length
//size: [5460.0, 395.0, 5460.0],
type: "tube",
r_max: 5460.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 5460.0,
position: [0.0, 0.0, 0.0],
material: "stainless_steel",
color: [0.2,0.2,0.9,0.2],
...
//type: "box",
//size: [4498.125, 24498.125, 4498.125], // mm, half-length
//size: [5450.0, 385, 5450.0],
type: "tube",
r_max: 5450.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 5450.0,
position: [0.0, 0.0, 0.0],
material: "doped_water",
color: [0.2,0.2,0.9,0.2],
...
//size: [5070.0,5.0,5070.0],
type: "tube",
r_max: 5070.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 5070.0,
position: [0.0, 0.0, 0.0],
...
//size: [5065.0,5065.0],
type: "tube",
r_max: 5065.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 5065.0,
position: [0.0, 0.0, 0.0],
material: "doped_water",
color: [0.2,0.2,0.9,0.2],
...
mother: "detector_target",
type: "pmtarray",
end_idx: 1471, //idx of the last pmt
