...
{ 
name: "GEO",
index: "midsurface_WLSP_reflector",
valid_begin: [0, 0],
valid_end: [0, 0],
invisible: 0, // omitted for visualization
mother: "WLSP_reflector", //not used but needs to be a valid name, parent of 'a' and 'b' would be best choice
type: "border",
volume1: "WLS_Plates",
...
pos_table: "WLSPBACKINFO",
size: [245.0,245.0,1.0],
z: [-1.1,1.1],
r_min: [0.0,0.0],
r_max: [126.5,126.5],
material: "polypropylene",
...
{
name: "GEO",
index: "midsurface_WLSP_reflector_back",
valid_begin: [0, 0],
valid_end: [0, 0],
invisible: 0, // omitted for visualization
mother: "WLSP_reflector_back", //not used but needs to be a valid name, parent of 'a' and 'b' would be best choice
type: "border",
volume1: "WLS_Plates",
volume2: "WLSP_reflector_back",
reverse: 1, //0 only considers photons from a->b, 1 does both directions
surface: "reflective_tarp",
}
