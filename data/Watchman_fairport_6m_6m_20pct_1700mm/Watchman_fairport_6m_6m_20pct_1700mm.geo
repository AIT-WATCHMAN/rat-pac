...
type: "box",
size: [34050.0, 31300.0, 34700.0], // mm, half-length
...
position: [0.0, 0.0, 8823.0], //this will allow for the concrete layer on the floor and not on the ceiling
material: "rock",
...
mother: "cavern_2",
type: "tube",
r_max: 3050.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 3050.0,
position: [0.0, 0.0, -8150.0],
material: "stainless_steel",
...
mother: "tank",
type: "tube",
r_max: 3000.0, // changed to accommodate 0.5m-thick layer of concrete on walls (L. Kneale)
size_z: 3000.0,
position: [0.0, 0.0, 0.0],
